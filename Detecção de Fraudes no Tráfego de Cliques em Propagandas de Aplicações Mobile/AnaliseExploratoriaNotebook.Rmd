...
output:
  html_document:
    df_print: paged
---
# <b>Problema de negócio: Criar um algoritmo que possa prever se um usuário fará o download de um aplicativo para dispositivos móveis depois de clicar em um determinado anúncio. </b>
